            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="space-y-6">
                        <Link href="/" className="text-3xl font-bold text-green-600">KFS Store</Link>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-gray-600">
                            <li><Link href="/aboutus" className="hover:text-green-600 transition-colors">About Us</Link></li>
                ...
                <div className="border-t border-gray-100 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-gray-500 text-sm">
                    <p>© 2026 KFS Store. All rights reserved.</p>
                    <div className="flex gap-4">
                        {/* Payment Icons */}
                        <span>VISA</span>
